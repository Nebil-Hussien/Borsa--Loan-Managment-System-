...
@section('content')
    ...
    <section class="content">
        <div id="app">
            <div class="row">
                <div class="col-md-12">
                @if(Auth::user()->user_role == "NGO")
                    <button data-toggle="modal" data-target="#remove_widget"
                            class="btn btn-danger margin float-right">
                        {{trans_choice('core::general.remove',1)}}  {{trans_choice('dashboard::general.widget',1)}}
                    </button>
                    <button data-toggle="modal" data-target="#add_widget" style="margin-right:5px;" 
                            class="btn btn-info margin float-right">
                        {{trans_choice('core::general.add',1)}}  {{trans_choice('dashboard::general.widget',1)}}
                    </button>
                @endif
                    </div>
                      <div class="modal fade" id="remove_widget">
                        <div class="modal-dialog">
                            <form method="post" action="{{ url('dashboard/remove_widget') }}"
                                  enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">{{trans_choice('core::general.remove',1)}}  {{trans_choice('dashboard::general.widget',1)}}</h4>
                                    ...
                                    <div class="modal-footer">
                                        {{-- <button type="button" class="btn btn-default pull-left"> {{trans_choice('core::general.remove',1)}}</button> --}}
