...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return theme_view('dashboard::dashboard', compact('available_widgets', 'user_widgets','user'));
    }
    ...
    public function remove_widget(Request $request)
    {
        ...
        Flash::warning(trans_choice("core::general.successfully_deleted", 1));
         return redirect()->back();
        //return response()->json(["success" => 1, "msg" => trans_choice("core::general.successfully_deleted", 1)]);
    }
