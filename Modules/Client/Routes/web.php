...
Route::prefix('client')->group(function () {
    ...
    //client City
    Route::prefix('client_city')->group(function () {
        Route::get('/', 'ClientCityController@index');
        Route::get('get_client_city', 'ClientCityController@get_client_city');
        Route::get('create', 'ClientCityController@create');
        Route::post('store', 'ClientCityController@store');
        Route::get('{id}/show', 'ClientCityController@show');
        Route::get('{id}/edit', 'ClientCityController@edit');
        Route::post('{id}/update', 'ClientCityController@update');
        Route::get('{id}/destroy', 'ClientCityController@destroy');
    });
    //client relationship
