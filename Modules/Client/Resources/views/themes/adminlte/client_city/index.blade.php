...
@section('title')
    {{ trans_choice('client::general.client', 1) }} {{ trans_choice('client::general.city', 2) }}
@endsection
@section('styles')
@stop
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('client::general.client', 1) }} {{ trans_choice('client::general.city', 2) }}
                    </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('client::general.client', 1) }}
                            {{ trans_choice('client::general.city', 2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="card">
            <div class="card-header">
                @can('client.clients.client_types.create')
                    <a href="{{ url('client/client_city/create') }}" class="btn btn-info btn-sm">
                        <i class="fas fa-plus"></i> {{ trans_choice('core::general.add', 1) }}
                        {{ trans_choice('core::general.city', 1) }}
                    </a>
                @endcan
                <div class="btn-group">
                    <div class="dropdown">
                ...
                <div class="card-tools">
                    <form class="form-inline ml-0 ml-md-3" action="{{ url('client/client_city') }}">
                ...
                <table class="table  table-striped table-hover table-condensed" id="data-table">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <a href="{{ table_order_link('shortName') }}">
                                    {{ trans_choice('core::general.shortName', 1) }}
                                </a>
                            </th>
                            <th>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            @can('client.clients.client_city.edit')
                                                <a href="{{ url('client/client_city/' . $key->id . '/edit') }}"
                                                    class="dropdown-item">
                                            ...
                                            @can('client.clients.client_city.destroy')
                                                <a href="{{ url('client/client_city/' . $key->id . '/destroy') }}"
