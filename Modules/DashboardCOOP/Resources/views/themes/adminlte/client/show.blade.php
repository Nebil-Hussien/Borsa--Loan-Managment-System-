                    ...
                    <div class="card card-primary card-outline card-outline-tabs">
                        <div class="card-header p-0 border-bottom-0">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="#registration_details" data-toggle="tab"
                                    aria-expanded="false">{{trans_choice('client::general.registration_details',2)}}
                                    </a>
                                </li>
                            
                                <li class="nav-item">
                                    <a class="nav-link" href="#accounts" data-toggle="tab"
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <!-- Registration Details -->
                                <div class="tab-pane active" id="registration_details">
                                
                                    @if($client->client_type_id==1) <!-- only show for individual type clients -->
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <h6 class="head_title">{{trans_choice('user::general.applicant_details',1)}}</h6>
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.first_name",1)}}</label><br /> {{ $client->first_name }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.middle_name",1)}}</label><br /> {{ $client->middle_name }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.last_name",1)}}</label><br /> {{ $client->last_name }}
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label>{{trans_choice("user::general.mother_name",1)}}</label><br /> {{ $client->mother_name }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.gender",1)}}</label><br /> {{ $client->gender }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.phone",1)}}</label><br /> {{ $client->mobile }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.age",1)}}</label><br /> {{ $client->age }}
                                        </div>
                                    </div>
                                    @endif
                                    
                                    @if($client->client_type_id==2) <!-- for company -->
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <h6 class="head_title">{{trans_choice('user::general.company_details',1)}}</h6>
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.company_name",1)}}</label><br /> {{ $client->company_name }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.business_type",1)}}</label><br /> {{ $client->business_type }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.registration_date",1)}}</label><br /> {{ (isset($client->registration_date) && !empty($client->registration_date) && $client->registration_date!="0000-00-00")?date("d M, Y",strtotime($client->registration_date)):"-" }}
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label>{{trans_choice("user::general.lic_number",1)}}</label><br /> {{ $client->lic_number }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.lic_renewal_date",1)}}</label><br /> {{ (isset($client->lic_renewal_date) && !empty($client->lic_renewal_date) && $client->lic_renewal_date!="0000-00-00")?date("d M, Y",strtotime($client->lic_renewal_date)):"-" }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.tin_number",1)}}</label><br /> {{ $client->tin_number }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.reg_capital",1)}}</label><br /> {{ $client->reg_capital }}
                                        </div>
                                    </div>
                                    
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <h6 class="head_title">{{trans_choice('user::general.c_address_details',1)}}</h6>
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.c_house_no",1)}}</label><br /> {{ $client->c_house_no }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.c_address",1)}}</label><br /> {{ $client->c_address }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.c_region",1)}}</label><br /> {{ $client->c_region }}
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label>{{trans_choice("user::general.c_city",1)}}</label><br /> {{ $client->c_city }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.c_zone",1)}}</label><br /> {{ $client->c_zone }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.c_kebele",1)}}</label><br /> {{ $client->c_kebele }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.c_state",1)}}</label><br /> {{ $client->c_state }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.country",1)}}</label><br /> {{ $client->country->name }}
                                        </div>
                                    </div>
                                    
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <h6 class="head_title">{{trans_choice('user::general.c_applicant_details',1)}}</h6>
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.r_first_name",1)}}</label><br /> {{ $client->first_name }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.r_middle_name",1)}}</label><br /> {{ $client->middle_name }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.r_last_name",1)}}</label><br /> {{ $client->last_name }}
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label>{{trans_choice("user::general.r_phone",1)}}</label><br /> {{ $client->mobile }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.gender",1)}}</label><br /> {{ $client->gender }}
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <h6 class="head_title">{{trans_choice('user::general.address_details',1)}}</h6>
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.house_no",1)}}</label><br /> {{ $client->house_no }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.address",1)}}</label><br /> {{ $client->address }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.region",1)}}</label><br /> {{ $client->region }}
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label>{{trans_choice("user::general.city",1)}}</label><br /> {{ $client->city }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.zone",1)}}</label><br /> {{ $client->zone }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.kebele",1)}}</label><br /> {{ $client->kebele }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.state",1)}}</label><br /> {{ $client->state }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.country",1)}}</label><br /> {{ $client->country->name }}
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <h6 class="head_title">{{trans_choice('user::general.identification',1)}}</h6>
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.identification_type",1)}}</label><br /> {{ $client->identification_type->name }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.identification_no",1)}}</label><br /> {{ $client->identification_no }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.identification_issued",1)}}</label><br /> @if(isset($client->identification_issued) && !empty($client->identification_issued) && $client->identification_issued!="0000-00-00 00:00:00"){{ date("d M, Y",strtotime($client->identification_issued)) }} @endif
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.identification_expire",1)}}</label><br /> @if(isset($client->identification_expire) && !empty($client->identification_expire) && $client->identification_expire!="0000-00-00 00:00:00"){{ date("d M, Y",strtotime($client->identification_expire)) }} @endif
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <h6 class="head_title">{{trans_choice('user::general.other_details',1)}}</h6>
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.how_many_child",1)}}</label><br /> {{ $client->total_children }}
                                        </div>
                                        <div class="col-md-3">
                                            <label>{{trans_choice("user::general.saving_account",1)}}</label><br /> {{ $client->saving_account }}
                                        </div>
                                        <div class="col-md-6">
                                            <label>{{trans_choice("user::general.exist_loan",1)}}</label><br /> {{ $client->exist_loan }}
                                        </div>
                                    </div>
                                    @endif
