    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body p-0">
                <table id="data-table" class="table table-striped table-condensed table-hover">
                    <thead>
                        <tr>
                            <th>
                                <span> {{ trans_choice('core::general.number', 1) }}
                            </th>
                            <th>
                            ...
                            <th>
                                <a href="{{ table_order_link('company_name') }}">
                                    <span>{{ trans_choice('client::general.company_name', 1) }}</span>
                                </a>
                            </th>

                            <th>
                                <a href="{{ table_order_link('city') }}">
                                    <span>{{ trans_choice('client::general.city', 1) }}</span>
                                </a>
                            </th>

                            <th>
                                <span>{{ trans_choice('client::general.mobile', 1) }}</span>
                            </th>

                            <th>
                                <a href="{{ table_order_link('principal') }}">
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $key)
                            <tr>
                                ...
                                <td>
                                    <span>
                                        {{ determine_the_city($key->city) }}
                                    </span>
                                </td>
                                <td>
                                    <span>{{ $key->clientMobile }}</span>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    @if ($key->status == 'overpaid')
                                        <span
                                            class="badge badge-warning">{{ trans_choice('loan::general.overpaid', 1) }}</span>
                                    @endif
                                    ...
                                    @if ($key->status == 'active')
                                        <span
                                            class="badge badge-info">{{ trans_choice('loan::general.active', 1) }}</span>
                                    @endif
                                    ...
                                    @if ($key->status == 'closed')
                                        <span
                                            class="badge badge-success">{{ trans_choice('loan::general.closed', 1) }}</span>
                                    @endif
                                    @if ($key->status == 'pending_reschedule')
                                        <span
                                            class="badge badge-warning">{{ trans_choice('loan::general.pending_reschedule', 1) }}</span>
                                    @endif
                                    @if ($key->status == 'rescheduled')
                                        <span
                                            class="badge badge-info">{{ trans_choice('loan::general.rescheduled', 1) }}</span>
                                    @endif
                                </td>
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-md-4">
                        <div>{{ trans_choice('core::general.page', 1) }} {{ $data->currentPage() }}
                            {{ trans_choice('core::general.of', 1) }} {{ $data->lastPage() }}</div>
                    </div>
                    <div class="col-md-4">
