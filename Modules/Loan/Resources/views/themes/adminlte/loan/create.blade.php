                            ...
                            <div class="col-md-6">
                                <div class="form-group" v-if="loan_product">
                                    ...
                                    <input type="text" name="interest_rate" id="interest_rate"
                                        v-model="interest_rate" value="7.000"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <flat-pickr v-model="expected_disbursement_date"
                                        ...
                                        name="expected_disbursement_date" id="expected_disbursement_date"
                                        onChange="ExpectedRepayment(this.value)" required>
                                    </flat-pickr>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="charges_table_body">
                                <tr v-for="(charge,index) in selected_charges" v-bind:id="charge.charge.id">
                                    ...
                                    {{-- <td><button class="fa fa-trash" aria-hidden="true" style="color: red"v-on:click="remove_charge" v-bind:data-id="index"></button>
                                    </td> --}}
                                    {{-- <td> <button type="button" class="fa fa-trash" aria-hidden="true" style="color: red" v-on:click="remove_charge" v-bind:value="index"></button></td> --}}
                                    <td class="text-end">
                                        <div class="table-action">
                                            <a v-on:click="remove_charge" v-bind:value="index"
                                                class="btn btn-sm bg-danger-light status_cancel" data-id="index">
                                                <i class="fas fa-trash" style="color: red" aria-hidden="true"></i> Cancel
                                            </a>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('loan_before') is-invalid @enderror"
                                    name="loan_before" id="loan_before" onChange="Loan_beforeChange(this.value)"
                                    required>
                                    <option value=""></option>
                                    <option value="1">{{ trans_choice('loan::general.yes', 1) }}
                                    </option>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="pricing_strategy" id="pricing_strategy"
                    ...
                    <div class="row gy-4">
                        <div class='col-md-6'>
                            <div class="form-group">
                                ...
                                <input type="numeric" name="own_capital" id="own_capital" pattern="[0-9]+([\.,][0-9]+)?"
                                    step="0.01"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('edir_status') is-invalid @enderror"
                                    name="edir_status" id="edir_status" onChange="edir_paymentChange(this.value)"
                                    required>
                                    <option value=""></option>
                                    <option value="1">{{ trans_choice('loan::general.yes', 1) }}
                                    </option>
    ...
    <script>
        var app = new Vue({
            ...
            data: {
                ...
                expected_first_payment_date: "{{ old('expected_first_payment_date',\Illuminate\Support\Carbon::today()->addMonths(3)->format('Y-m-d')) }}",
            ...
            methods: {
                ...
                remove_charge(event) {
                    this.selected_charges.pop(this.loan_product_charges[this.selected_charge]);
                },
                change_loan_product() {
