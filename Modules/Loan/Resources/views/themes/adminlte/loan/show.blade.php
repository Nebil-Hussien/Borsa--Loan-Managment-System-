            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('loan::general.loan', 1) }}
                            {{ trans_choice('core::general.detail', 2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <flat-pickr
                                                                        ...
                                                                        name="approved_on_date" value="{{ date('Y-m-d') }}"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" name="approved_amount"
                                                                        ...
                                                                        value="{{ $loan->applied_amount }}" required=""
                                                                        id="approved_amount">
                                                                </div>
                                                                <div class="form-group">
                                    ...
                                    @if ($loan->status == 'active')
                                        ...
                                        @can('loan.loans.charges.create')
                                            <a href="{{ url('loan/' . $loan->id . '/charge/create') }}"
                                                ...
                                                {{ trans_choice('core::general.add', 1) }}
                                                {{ trans_choice('loan::general.charge', 1) }}
                                            </a>
                                        @endcan
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control select2" name="loan_officer_id"
                                                                        id="loan_officer_id" v-model="loan_officer_id" required>
                                                                        <option value=""></option>
                                                                        @foreach ($users as $key)
                                                                            <option value="{{ $key->id }}"
                                                                                @if ($key->id == $loan->loan_officer_id) selected @endif>
                                                                                {{ $key->first_name }}
                                                                                {{ $key->last_name }}
                                                                            </option>
                                                                        @endforeach
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <flat-pickr
                                                                        ...
                                                                        name="date" value="{{ date('Y-m-d') }}" id="date"
                                                                        required>
                                                                    </flat-pickr>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="interest_waived_amount"
                                                                        class="form-control numeric" value="" required=""
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <flat-pickr
                                                                        ...
                                                                        value="{{ date('Y-m-d') }}" id="written_off_on_date"
                                                                        required>
                                                                    </flat-pickr>
                                                                </div>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <flat-pickr v-model="rescheduled_on_date"
                                                                        ...
                                                                        required id="rescheduled_on_date"></flat-pickr>
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group"
                                                                    ...
                                                                    <flat-pickr v-model="rescheduled_first_payment_date"
                                                                        name="rescheduled_first_payment_date"
                                                                ...
                                                                <div class="form-group"
                                                                    ...
                                                                    <input type="text" id="reschedule_extra_installments"
                                                                ...
                                                                <div class="form-group"
                                                                    ...
                                                                    <input type="text" id="reschedule_grace_on_principal_paid"
                                                                ...
                                                                <div class="form-group"
                                                                    ...
                                                                    <input type="text" id="reschedule_grace_on_interest_paid"
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="rescheduled_notes"
                                                                        class="control-label">{{ trans_choice('core::general.note', 2) }}</label>
                                                                    <textarea name="rescheduled_notes" v-model="rescheduled_notes" class="form-control" id="rescheduled_notes" rows="3"
                                                                        required></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                                        ...
                                                        <form method="post"
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <flat-pickr name="disbursed_on_date"
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="first_payment_date"
                                                                        class="control-label">{{ trans_choice('core::general.first', 1) }}
                                                                        {{ trans_choice('loan::general.repayment', 1) }}
                                                                        {{ trans_choice('core::general.date', 1) }}</label>

                                                                    <flat-pickr name="first_payment_date"
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="approved_amount"
                                                                        ...
                                                                        {{ trans_choice('loan::general.payment', 1) }}
                                                                        {{ trans_choice('core::general.detail', 2) }}</label>
                                                                ...
                                                                <div id="show_payment_details" class="collapse">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="cheque_number"
                                                                            class="form-control" value="" id="cheque_number">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="routing_code"
                                                                            class="form-control" value="" id="routing_code">
                                                                    </div>
                                                                    <div class="form-group">
                        ...
                        <div class="row" style="margin-top: 20px">
                            <div class="col-sm-8 col-md-8 p-10">
                                @if ($loan->status == 'submitted' || $loan->status == 'pending' || $loan->status == 'withdrawn' || $loan->status == 'approved' || $loan->status == 'rejected')
                                    @if ($loan->status == 'submitted')
                                        <span
                                            class="badge badge-warning badge-lg m-2 status-label">{{ trans_choice('loan::general.pending_approval', 1) }}</span>
                                    @endif
                                    @if ($loan->status == 'approved')
                                        <span
                                            class="badge badge-warning badge-lg m-2  status-label">{{ trans_choice('loan::general.awaiting_disbursement', 1) }}</span>
                                    @endif
                                    @if ($loan->status == 'withdrawn')
                                        <span
                                            class="badge badge-danger badge-lg m-2  status-label">{{ trans_choice('loan::general.withdrawn', 1) }}</span>
                                    @endif
                                    @if ($loan->status == 'rejected')
                                        <span
                                            class="badge badge-danger badge-lg m-2  status-label">{{ trans_choice('loan::general.rejected', 1) }}</span>
                                    @endif
                                @endif
                                @if ($loan->status == 'active' || $loan->status == 'closed' || $loan->status == 'written_off' || $loan->status == 'overpaid' || $loan->status == 'rescheduled')
                                    ...
                                    $current_principal = $loan->repayment_schedules
                                        ->where('due_date', '=', date('Y-m-d'))
                                        ->where('paid_by_date', '=', null)
                                        ->pluck('total_due')
                                        ->first();
                                    // console.log($current_principal);
                                    ...
                                    $arrears_last_schedule = $loan->repayment_schedules
                                        ...
                                        ->where('total_due', '>', 0)
                                        ->first();
                                    //error_log($arrears_last_schedule);
                                    if (!empty($arrears_last_schedule)) {
                                        $overdue_schedules = $loan->repayment_schedules->where('paid_by_date', '=', null)->where('due_date', '<=', $arrears_last_schedule->due_date);
                                    ...
                                    $current_principal += $arrears_amount;
                                    ?>
                                    ...
                                    <!-- h4 class="hidden">
                                                            {{ trans_choice('loan::general.timely', 1) }}
                                    ...
                                    <h4 class="">
                                        ...
                                        {{ trans_choice('core::general.in', 1) }}
                                        {{ trans_choice('loan::general.arrears', 1) }}
                                        :
                                        <b
                                            class=" @if ($arrears_amount) text-danger @endif">{{ number_format($arrears_amount, 2) }}</b>
                                    </h4>
                                    <h4 class="">
                                        ...
                                        :
                                        <b
                                            class=" @if ($arrears_days) text-danger @endif">{{ $arrears_days }}</b>

                                    </h4>
                                    <h4 class="">
                                        {{ trans_choice('loan::general.currentPayble', 1) }}
                                        :
                                        <b class="">{{ number_format($current_principal, 2) }}
                                        </b>
                                    ...
                                    <table class="pretty displayschedule" id="summarytable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{ number_format($principal_waived, 2) }}</td>
                                                <td>{{ number_format($principal_written_off, 2) }}</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ number_format($interest_waived, 2) }}</td>
                                                <td>{{ number_format($interest_written_off, 2) }}</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ number_format($fees_waived, 2) }}</td>
                                                <td>{{ number_format($fees_written_off, 2) }}</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ number_format($penalties_paid, 2) }}</td>
                                                <td>{{ number_format($penalties_waived, 2) }}</td>
                                                <td>{{ number_format($penalties_written_off, 2) }}</td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th>{{ number_format($principal + $interest + $penalties + $fees, 2) }}
                                                </th>
                                                <th>{{ number_format($principal_paid + $interest_paid + $fees_paid + $penalties_paid, 2) }}
                                                </th>
                                                <th>{{ number_format($principal_waived + $interest_waived + $fees_waived + $penalties_waived, 2) }}
                                                </th>
                                                <th>{{ number_format($principal_written_off + $interest_written_off + $fees_written_off + $penalties_written_off, 2) }}
                                                </th>
                                                <th>{{ number_format($principal_outstanding + $interest_outstanding + $fees_outstanding + $penalties_outstanding, 2) }}
                                                </th>
                                                <th>{{ number_format($principal_overdue + $interest_overdue + $fees_overdue + $penalties_overdue, 2) }}
                                                </th>
                                            </tr>
                                        </tfoot>
                                    </table>
                            ...
                            <div class="col-sm-4 col-md-4">
                                <table class="table table-striped table-bordered ">
                                    <tbody>
                                        <tr>
                                            <th class="table-bold-loan">{{ trans_choice('loan::general.status', 1) }}
                                            </th>
                                            <td>
                                                @if ($loan->status == 'submitted')
                                                    <span
                                                        class="badge badge-warning">{{ trans_choice('loan::general.pending_approval', 1) }}</span>
                                                @endif
                                                @if ($loan->status == 'approved')
                                                    <span
                                                        class="badge badge-warning">{{ trans_choice('loan::general.awaiting_disbursement', 1) }}</span>
                                                @endif
                                                @if ($loan->status == 'active')
                                                    <span
                                                        class="badge badge-success">{{ trans_choice('loan::general.active', 1) }}</span>
                                                @endif
                                                @if ($loan->status == 'withdrawn')
                                                    <span
                                                        class="badge badge-danger">{{ trans_choice('loan::general.withdrawn', 1) }}</span>
                                                @endif
                                                @if ($loan->status == 'rejected')
                                                    <span
                                                        class="badge badge-danger">{{ trans_choice('loan::general.rejected', 1) }}</span>
                                                @endif
                                                @if ($loan->status == 'closed')
                                                    <span
                                                        class="badge badge-info">{{ trans_choice('loan::general.closed', 1) }}</span>
                                                @endif
                                                @if ($loan->status == 'written_off')
                                                    <span
                                                        class="badge badge-danger">{{ trans_choice('loan::general.written_off', 1) }}</span>
                                                @endif
                                                @if ($loan->status == 'rescheduled')
                                                    <span
                                                        class="badge badge-warning">{{ trans_choice('loan::general.rescheduled', 1) }}</span>
                                                @endif
                                                @if ($loan->status == 'overpaid')
                                                    <span
                                                        class="badge badge-info">{{ trans_choice('loan::general.overpaid', 1) }}</span>
                                                @endif
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="table-bold-loan">{{ trans_choice('client::general.client', 1) }}
                                            </th>
                                            <td>
                                                @if (!empty($loan->client))
                                                    <a href="{{ url('client/' . $loan->client_id . '/show') }}">{{ $loan->client->first_name }}
                                                        {{ $loan->client->middle_name }}
                                                        {{ $loan->client->last_name }}</a>
                                                @endif
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="table-bold-loan">{{ trans_choice('core::general.currency', 1) }}
                                            </th>
                                            <td>
                                        ...
                                        <tr>
                                            <th class="table-bold-loan">{{ trans_choice('loan::general.loan', 1) }}
                                                {{ trans_choice('loan::general.officer', 1) }}</th>
                                            <td>
                                        ...
                                        <tr>
                                            <th class="table-bold-loan">{{ trans_choice('loan::general.fund', 1) }}
                                            </th>
                                            <td>
                                                @if (!empty($loan->fund))
                                                    {{ $loan->fund->name }}
                                        ...
                                        <tr>
                                            <th class="table-bold-loan">
                                                {{ trans_choice('loan::general.applied_amount', 1) }}</th>
                                            <td>
                                        ...
                                        @if ($loan->status == 'active' || $loan->status == 'closed' || $loan->status == 'approved' || $loan->status == 'written_off' || $loan->status == 'overpaid' || $loan->status == 'rescheduled')
                                            <tr>
                                                <th class="table-bold-loan">
                                                    {{ trans_choice('loan::general.approved_amount', 1) }}</th>
                                                <td>
                                        ...
                                        @if ($loan->status == 'pending' || $loan->status == 'approved' || $loan->status == 'submitted')
                                            <tr>
                                                <th class="table-bold-loan">
                                                    ...
                                                    {{ trans_choice('loan::general.disbursement', 1) }}
                                                    {{ trans_choice('core::general.date', 1) }}</th>
                                                <td>
                                        ...
                                        @if ($loan->status == 'active' || $loan->status == 'closed' || $loan->status == 'written_off' || $loan->status == 'overpaid' || $loan->status == 'rescheduled')
                                            <tr>
                                                <th class="table-bold-loan">
                                                    {{ trans_choice('loan::general.disbursed_amount', 1) }}</th>
                                                <td>
                                        ...
                                        <tr>
                                            <th class="table-bold-loan">
                                                {{ trans_choice('loan::general.profitablity', 1) }}
                                            </th>
                                            <td>
                                        ...
                                        <tr>
                                            <th class="table-bold-loan">
                                                {{ trans_choice('loan::general.feasiblity_check', 1) }}
                                            </th>
                                            <td>
                                                {{ $financial->feasiblity_check }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a href="#account_details" class="nav-link active" data-toggle="tab">
                                    {{ trans_choice('loan::general.account', 1) }}
                            ...
                            @if ($loan->status == 'active' || $loan->status == 'closed' || $loan->status == 'written_off' || $loan->status == 'overpaid' || $loan->status == 'rescheduled')
                                <li class="nav-item">
                                    <a href="#repayment_schedule" class="nav-link" data-toggle="tab">
                                        {{ trans_choice('loan::general.repayment', 1) }}
                                        {{ trans_choice('loan::general.schedule', 1) }}
                                    </a>
                                </li>
                            ...
                            @can('loan.loans.guarantors.index')
                                <li class="nav-item">
                                    <a href="#loan_guarantors" class="nav-link" data-toggle="tab">
                            ...
                            @can('loan.loans.guarantors.index')
                                <li class="nav-item">
                                    <a href="#loan_overview" class="nav-link" data-toggle="tab">
                                        {{ trans_choice('loan::general.overview', 2) }}
                                    </a>
                                </li>
                            @endcan
                        </ul>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="account_details">
                                <table class="table table-striped table-hover">
                                    <tbody>
                                        <tr>
                                            <td>{{ trans_choice('loan::general.loan_transaction_processing_strategy', 1) }}
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>{{ trans_choice('loan::general.loan', 1) }}
                                                {{ trans_choice('loan::general.term', 1) }}</td>
                                            <td>
                                                {{ $loan->loan_term }}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{ trans_choice('loan::general.every', 1) }}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if (!empty($loan->submitted_by))
                                                    ...
                                                    {{ $loan->submitted_by->first_name }}
                                                    {{ $loan->submitted_by->last_name }}
                                                @endif
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>{{ trans_choice('loan::general.approved', 1) }}
                                                {{ trans_choice('core::general.on', 1) }}</td>
                                            <td>
                                                {{ $loan->approved_on_date }}
                                                @if (!empty($loan->approved_by))
                                                    {{ trans_choice('core::general.by', 1) }}
                                                    {{ $loan->approved_by->first_name }}
                                                    {{ $loan->approved_by->last_name }}
                                                @endif
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if (!empty($loan->disbursed_by))
                                                    {{ trans_choice('core::general.by', 1) }}
                                                    {{ $loan->disbursed_by->first_name }}
                                                    {{ $loan->disbursed_by->last_name }}
                                                @endif
                                            </td>
                                        </tr>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left">
                                                ...
                                                <a href="{{ url('loan/' . $loan->id . '/schedule/pdf') }}"
                                                    ...
                                                    {{ trans_choice('core::general.download', 1) }}
                                                    {{ trans_choice('core::general.pdf', 1) }}
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col">{{ trans_choice('loan::general.paid', 1) }}
                                                    {{ trans_choice('core::general.by', 1) }}</th>
                                                <th scope="col"></th>
                                                ...
                                                <th class="righthighlightcolheader" scope="col">
                                                    {{ trans_choice('loan::general.penalty', 2) }}</th>
                                                <th scope="col">{{ trans_choice('loan::general.monthly', 1) }}
                                                    {{ trans_choice('loan::general.due', 1) }}</th>                                                
                                                <th scope="col">{{ trans_choice('loan::general.total', 1) }}
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="lefthighlightcolheader">
                                                    {{ number_format($loan->principal, 2) }}</td>
                                                <td></td>
                                                <td class="righthighlightcolheader">
                                                    {{ number_format($loan->principal, 2) }}</td>
                                                <td class="lefthighlightcolheader"></td>
                                                <td>{{ number_format($loan->disbursement_charges, 2) }}
                                                </td>
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>{{ trans_choice('loan::general.transaction', 1) }}
                                                        {{ trans_choice('core::general.type', 1) }}</th>
                                                    <th>{{ trans_choice('loan::general.transaction', 1) }}
                                                        {{ trans_choice('core::general.id', 1) }}</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if ($key->loan_transaction_type_id == 5)
                                                                {{ trans_choice('loan::general.repayment', 1) }}
                                                                {{ trans_choice('core::general.at', 1) }}
                                                                {{ trans_choice('loan::general.disbursement', 1) }}
                                                            @endif
                                                            ...
                                                            @if ($key->loan_transaction_type_id == 10)
                                                                ...
                                                                {{ trans_choice('loan::general.applied', 1) }}
                                                            @endif
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a href="{{ url('loan/transaction/' . $key->id . '/show') }}"
                                                                        ...
                                                                        {{ trans_choice('core::general.view', 2) }}
                                                                    </a>
                            ...
                            @can('loan.loans.charges.index')
                                <div class="tab-pane" id="loan_charges">
                                    @can('loan.loans.charges.create')
                                        <a href="{{ url('loan/' . $loan->id . '/charge/create') }}"
                                            class="btn btn-info float-right m-2">{{ trans_choice('core::general.add', 1) }}
                                            {{ trans_choice('loan::general.charge', 1) }}</a>
                                    @endcan
                                    <table class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>{{ trans_choice('core::general.name', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.charge', 1) }}
                                                    {{ trans_choice('core::general.type', 1) }}</th>
                                ...
                                <div class="tab-pane" id="loan_files">
                                    @can('loan.loans.files.create')
                                        <a href="{{ url('loan/' . $loan->id . '/file/create') }}"
                                            class="btn btn-info float-right m-2">{{ trans_choice('core::general.add', 1) }}
                                            {{ trans_choice('loan::general.file', 1) }}</a>
                                    @endcan
                                    <table class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            @foreach ($loan->files as $key)
                                                <tr>
													...
													<td>{{$key->link}}</td>
                                                    <td>
                                                       <a href="{{ url('loan/file/download',$key->link)}}"
                                ...
                                <div class="tab-pane" id="loan_guarantors">
                                    @can('loan.loans.guarantors.create')
                                        <a href="{{ url('loan/' . $loan->id . '/guarantor/create') }}"
                                            class="btn btn-info float-right m-2">{{ trans_choice('core::general.add', 1) }}
                                            {{ trans_choice('loan::general.guarantor', 1) }}</a>
                                    @endcan
                                    <table class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        @if ($key->is_client == 1)
                                                            ...
                                                            @endif
                                                        @else
                                                            {{ $key->first_name }} {{ $key->middle_name }}
                                                            {{ $key->last_name }}
                                                        @endif
                                                    </td>
                                                    <td>{{ number_format($key->guaranteed_amount, 2) }}</td>
                                                    <td>
                                                        @if ($key->is_client == 1)
                            ...
                            {{-- Overview of Data --}}
                            @can('loan.loans.guarantors.index')
                                <div class="tab-pane" id="loan_overview" style="overflow-x:auto;">
                                    <table class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>{{ trans_choice('loan::general.bussiness_sector', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.reason_bussiness_sector', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.taken_skills_show', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.ownres_of_bussiness', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.bank_saving_account', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.estimated_market_size', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.market_potential', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.sales_approach', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.direct_employee', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.indirect_employee', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.supplier_amount', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.expected_risk_of_bussiness', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.martial_status_show', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.tin_number', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.tin_number2', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.physical_bussiness_show', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.loan_before_show', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.round_of_loan_show', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.repayment_history_status_show', 1) }}
                                                </th>
                                                <th>{{ trans_choice('loan::general.reason_history_status_show', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.curret_asset_amount', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.current_liability_amount', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.long_term_liability_amount', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.annualy_income', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.monthly_income', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.daily_income', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.annualy_expense', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.monthly_expense', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.daily_expense', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.book_of_records_show', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.edir_status_show', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.edir_paymend_status_show', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.equb_status_show', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.equb_status_payment_show', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.community_role_status_show', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.utillity_payment_status_show', 1) }}</th>
                                                <th>{{ trans_choice('loan::general.fines_penalities_statu_shows', 1) }}</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    @if ($kyc->bussiness_sector_id == 1)
                                                        {{ trans_choice('loan::general.bussiness_sector_chicken_farming', 1) }}
                                                    @endif
                                                    @if ($kyc->bussiness_sector_id == 2)
                                                        {{ trans_choice('loan::general.bussiness_sector_animal_farming', 1) }}
                                                    @endif
                                                    @if ($kyc->bussiness_sector_id == 3)
                                                        {{ trans_choice('loan::general.bussiness_sector_diary_product', 1) }}
                                                    @endif
                                                    @if ($kyc->bussiness_sector_id == 4)
                                                        {{ trans_choice('loan::general.bussiness_sector_merchandise', 1) }}
                                                    @endif
                                                    @if ($kyc->bussiness_sector_id == 5)
                                                        {{ trans_choice('loan::general.bussiness_sector_woodwork_metal', 1) }}
                                                    @endif
                                                    @if ($kyc->bussiness_sector_id == 6)
                                                        {{ trans_choice('loan::general.bussiness_sector_garment', 1) }}
                                                    @endif
                                                    @if ($kyc->bussiness_sector_id == 7)
                                                        {{ trans_choice('loan::general.bussiness_sector_petty_trade', 1) }}
                                                    @endif
                                                    @if ($kyc->bussiness_sector_id == 8)
                                                        {{ trans_choice('loan::general.bussiness_sector_other', 1) }}
                                                    @endif
                                                </td>
                                                <td> {{ $kyc->reason_bussiness }}</td>

                                                <td>
                                                    @if ($kyc->knowledge_id == 1)
                                                        {{ trans_choice('loan::general.bussiness_managment', 1) }}
                                                    @endif
                                                    @if ($kyc->knowledge_id == 2)
                                                        {{ trans_choice('loan::general.financial_services', 1) }}
                                                    @endif
                                                    @if ($kyc->knowledge_id == 3)
                                                        {{ trans_choice('loan::general.cash_management', 1) }}
                                                    @endif
                                                    @if ($kyc->knowledge_id == 4)
                                                        {{ trans_choice('loan::general.budegeting', 1) }}
                                                    @endif
                                                    @if ($kyc->knowledge_id == 5)
                                                        {{ trans_choice('loan::general.responsible_borrowing', 1) }}
                                                    @endif
                                                    @if ($kyc->knowledge_id == 6)
                                                        {{ trans_choice('loan::general.saving', 1) }}
                                                    @endif
                                                </td>
                                                <td> {{ $kyc->owners_of_bussiness }}</td>
                                                <td> {{ $kyc->bank_saving_account }}</td>
                                                <td> {{ $bussiness_plan->estimated_market_size }}</td>
                                                <td> {{ $bussiness_plan->market_potential }}</td>
                                                <td> {{ $bussiness_plan->sales_approach }}</td>
                                                <td> {{ $bussiness_plan->direct_employee }}</td>
                                                <td> {{ $bussiness_plan->indirect_employee }}</td>
                                                <td> {{ $bussiness_plan->supplier_amount }}</td>
                                                <td> {{ $bussiness_plan->expected_risk_of_bussiness }}</td>
                                                <td> {{ $kyc->martial_status }}</td>
                                                <td> {{ $kyc->tin_number }} </td>
                                                <td> {{ $kyc->tin_number2 }} </td>
                                                <td>
                                                    @if ($kyc->physical_bussiness == 1)
                                                        {{ trans_choice('loan::general.yes', 1) }}
                                                    @endif
                                                    @if ($kyc->physical_bussiness == 0)
                                                        {{ trans_choice('loan::general.no', 1) }}
                                                    @endif
                                                </td>
                                                <td>
                                                    @if ($kyc->loan_before == 1)
                                                        {{ trans_choice('loan::general.yes', 1) }}
                                                    @endif
                                                    @if ($kyc->loan_before == 0)
                                                        {{ trans_choice('loan::general.no', 1) }}
                                                    @endif
                                                </td>
                                                <td> {{ $kyc->number_rounds_loan }} </td>

                                                <td>
                                                    @if ($kyc->repayment_history_status == 1)
                                                        {{ trans_choice('loan::general.yes', 1) }}
                                                    @endif
                                                    @if ($kyc->repayment_history_status == 0)
                                                        {{ trans_choice('loan::general.no', 1) }}
                                                    @endif
                                                </td>
                                                <td> {{ $kyc->reason_histroy_loan }}</td>
                                                <td> {{ number_format($financial->current_asset_amount,2) }}</td>
                                                <td> {{ number_format($financial->current_liability_amount,2) }}</td>
                                                <td> {{ number_format($financial->long_term_liabilit_amount,2) }}</td>
                                                <td> {{ number_format($financial->annual_income_bussiness,2) }}</td>
                                                <td> {{ number_format($financial->monthly_income_bussiness,2) }}</td>
                                                <td> {{ number_format($financial->daily_income_bussiness,2) }}</td>
                                                <td> {{ number_format($financial->annual_expense,2) }} </td>
                                                <td> {{ number_format($financial->monthly_expense,2) }}</td>
                                                <td> {{ number_format($financial->daily_expesnse,2) }} </td>

                                                <td>
                                                    @if ($others->book_of_records == 1)
                                                        {{ trans_choice('loan::general.yes', 1) }}
                                                    @endif
                                                    @if ($others->book_of_records == 0)
                                                        {{ trans_choice('loan::general.no', 1) }}
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    @if ($others->edir_status == 1)
                                                        {{ trans_choice('loan::general.yes', 1) }}
                                                    @endif
                                                    @if ($others->edir_status == 0)
                                                        {{ trans_choice('loan::general.no', 1) }}
                                                    @endif
                                                </td>

                                                <td>
                                                    @if ($others->edir_payment_status == 1)
                                                        {{ trans_choice('loan::general.yes', 1) }}
                                                    @endif
                                                    @if ($others->edir_payment_status == 0)
                                                        {{ trans_choice('loan::general.no', 1) }}
                                                    @endif
                                                </td>

                                                <td>
                                                    @if ($others->equib_status == 1)
                                                        {{ trans_choice('loan::general.yes', 1) }}
                                                    @endif
                                                    @if ($others->equib_status == 0)
                                                        {{ trans_choice('loan::general.no', 1) }}
                                                    @endif
                                                </td>

                                                <td>
                                                    @if ($others->equib_payment_status == 1)
                                                        {{ trans_choice('loan::general.yes', 1) }}
                                                    @endif
                                                    @if ($others->equib_payment_status == 0)
                                                        {{ trans_choice('loan::general.no', 1) }}
                                                    @endif
                                                </td>

                                                <td>
                                                    @if ($others->community_role_status == 1)
                                                        {{ trans_choice('loan::general.yes', 1) }}
                                                    @endif
                                                    @if ($others->community_role_status == 0)
                                                        {{ trans_choice('loan::general.no', 1) }}
                                                    @endif
                                                </td>

                                                <td>
                                                    @if ($others->utillites_payment_status == 1)
                                                        {{ trans_choice('loan::general.yes', 1) }}
                                                    @endif
                                                    @if ($others->utillites_payment_status == 0)
                                                        {{ trans_choice('loan::general.no', 1) }}
                                                    @endif
                                                </td>
                                                <td>
                                                    @if ($others->fines_penalities_status == 1)
                                                        {{ trans_choice('loan::general.yes', 1) }}
                                                    @endif
                                                    @if ($others->fines_penalities_status == 0)
                                                        {{ trans_choice('loan::general.no', 1) }}
                                                    @endif
                                                </td>
                                            </tr>
                                ...
                                <div class="tab-pane" id="loan_notes">
                                    @can('loan.loans.notes.create')
                                        <a href="{{ url('loan/' . $loan->id . '/note/create') }}"
                                            class="btn btn-info float-right m-2">{{ trans_choice('core::general.add', 1) }}
                                            {{ trans_choice('core::general.note', 1) }}</a>
                                    @endcan
                                                ...
                                                <div class="media-body">
                                                    <h4 class="media-heading user_name">
                                                        @if (!empty($key->created_by))
                                                            <a>{{ $key->created_by->first_name }}
                                                                {{ $key->created_by->last_name }}</a>
                                                        @endif
                                                        <small>{{ trans_choice('core::general.on', 1) }}
                                                    ...
                                                    <p>
                                                        @can('loan.loans.notes.edit')
                                                            <a href="{{ url('loan/note/' . $key->id . '/edit') }}"
                                                                class="btn btn-xs btn-tool"><i class="fas fa-edit"></i> </a>
                                                        @endcan
