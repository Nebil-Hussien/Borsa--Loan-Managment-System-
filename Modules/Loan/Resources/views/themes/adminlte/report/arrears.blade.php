            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('loan::general.loan', 1) }}
                        {{ trans_choice('loan::general.arrears', 1) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('loan::general.loan', 1) }}
                            {{ trans_choice('loan::general.arrears', 1) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="card-tools hidden-print">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-xs dropdown-menu-right">
                            <a href="{{ url('report/loan/arrears?download=1&type=csv&end_date=' . $end_date . '&branch_id=' . $branch_id . '&city_id=' . $city_id) }}"
                                class="dropdown-item">{{ trans_choice('core::general.download', 1) }}
                                {{ trans_choice('core::general.csv_format', 1) }}</a>
                            <a href="{{ url('report/loan/arrears?download=1&type=excel&end_date=' . $end_date . '&branch_id=' . $branch_id . '&city_id=' . $city_id) }}"
                                class="dropdown-item">{{ trans_choice('core::general.download', 1) }}
                                {{ trans_choice('core::general.excel_format', 1) }}</a>
                            <a href="{{ url('report/loan/arrears?download=1&type=excel_2007&end_date=' . $end_date . '&branch_id=' . $branch_id . '&city_id=' . $city_id) }}"
                                class="dropdown-item">{{ trans_choice('core::general.download', 1) }}
                                {{ trans_choice('core::general.excel_2007_format', 1) }}</a>
                            <a href="{{ url('report/loan/arrears?download=1&type=pdf&end_date=' . $end_date . '&branch_id=' . $branch_id . '&city_id=' . $city_id) }}"
                                class="dropdown-item">{{ trans_choice('core::general.download', 1) }}
                    ...
                    <table class="table table-bordered table-condensed table-hover">
                        <thead>
                            ...
                            <tr style="background-color: #D1F9FF">
                                ...
                                <th>{{ trans_choice('loan::general.approved', 1) }}
                                    {{ trans_choice('core::general.date', 1) }}</th>
                                <th>{{ trans_choice('loan::general.disbursed', 1) }}
                                    {{ trans_choice('core::general.date', 1) }}</th>
                                <th>{{ trans_choice('loan::general.maturity', 1) }}
                                    {{ trans_choice('core::general.date', 1) }}</th>
                                ...
                                <th>{{ trans_choice('loan::general.day', 2) }}
                                    {{ trans_choice('loan::general.since', 1) }}
                                    {{ trans_choice('core::general.last', 1) }}
                                    {{ trans_choice('core::general.payment', 1) }}</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            @foreach ($data as $key)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (\Illuminate\Support\Carbon::parse()->lessThan(
                                            \Illuminate\Support\Carbon::parse($key->expected_maturity_date)))
