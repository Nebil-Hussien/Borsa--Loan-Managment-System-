...
?>
<img class="logo_image" src="{{asset('theme/img/logo.png')}}" class="img-fluid" alt="Logo">
<h3 class="text-center">"Bussiness Agent Report</h3>
<table class="table table-bordered table-striped table-hover">
    <thead>
    <tr>
        <th>"Report Date & Time: " {{$current_date_time}}</th>>
