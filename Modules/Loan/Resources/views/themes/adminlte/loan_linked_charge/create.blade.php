                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select class="form-control  @error('loan_charge_id') is-invalid @enderror" name="loan_charge_id" id="loan_charge_id"
                            ...
                            <option value=""></option>
                            <option v-for="data in charges" v-bind:value= data.id>
                                @{{ data.name }}
                            </option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="amount" value="{{ number_format(old('amount'),2) }}" id="amount" v-model="amount" pattern="[0-9]+([\.,][0-9]+)?" step="0.01"
