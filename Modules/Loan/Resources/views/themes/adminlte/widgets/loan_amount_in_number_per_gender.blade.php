<div class="grid-stack-item" gs-x="{{ $config['x'] }}" gs-y="{{ $config['y'] }}" gs-w="{{ $config['width'] }}"
    gs-h="{{ $config['height'] }}" gs-id="LoanAmountInNumberPerGender" draggable="true">
    <div class="grid-stack-item-content">
          <div class="card card-bordered card-preview">
            <div class="card-header with-border">
                <h3 class="card-title">{{ trans_choice('core::general.loan_disbursed_number_per_gender', 1) }}</h3>
