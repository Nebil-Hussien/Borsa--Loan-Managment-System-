...
use Modules\Loan\Charts\LoanAmountInAmountRejectedPerGenderBarChart;
use Modules\Loan\Entities\Loan;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Auth;

class LoanAmountInAmountRejectedPerGender extends AbstractWidget{
    /**
     ...
     */
     public function run()
    {
        $chart = new LoanAmountInAmountRejectedPerGenderBarChart();
        $labels = [];
        $labels1 = [];
        $data = [];
        $data1 = [];
    ...
    $chart->title(trans_choice('core::general.loan_disbursed_rejected_per_gender', 1));
