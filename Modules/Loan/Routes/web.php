...
Route::prefix('loan')->group(function () {
    ...
    //Route::post('store', 'LoanController@add_data')->name('store.add_data');
	...
	Route::get('file/download/{link}', 'LoanFileController@download');
...
Route::prefix('report')->group(function () {
    ...
    Route::get('loan/loan_status', 'ReportController@loan_status_report');
    Route::get('loan/loan_application_report', 'ReportController@loan_application_report');
    Route::get('loan/loan_approved_report', 'ReportController@loan_approved_report');
    Route::get('loan/loan_rejected_report', 'ReportController@loan_rejected_report');
    Route::get('loan/client_report', 'ReportController@client_reports');
    Route::get('loan/mfi_officer_collection_sheet', 'ReportController@mfi_officer_collection_sheet');
    Route::get('loan/general_mfi_repayment', 'ReportController@general_mfi_repayment');
    Route::get('loan/mfi_repayment', 'ReportController@mfi_repayment');
});