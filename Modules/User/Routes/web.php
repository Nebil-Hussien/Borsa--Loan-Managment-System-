...
Route::prefix('microLoan')->group(function () {
     Route::get('/', 'Auth\LoginController@microLoan');

});
Route::prefix('services')->group(function () {
    Route::get('/', 'Auth\LoginController@home');
    Route::get('/mircoLoan', 'Auth\LoginController@microLoan');
   
});
Route::prefix('company')->group(function () {
    Route::get('/', 'Auth\CompanyController@showRegistrationForm');
    Route::post('/create_company', 'Auth\CompanyController@create');
});
Route::prefix('user')->group(function () {
    ...
    Route::get('{id}/qrGenerate', 'UserController@Qrgenerator');
