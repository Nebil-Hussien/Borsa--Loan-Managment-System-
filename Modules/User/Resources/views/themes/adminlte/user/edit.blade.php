                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('core::general.edit', 1) }}
                            {{ trans_choice('user::general.user', 1) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="middle_name"
                                        class="control-label">{{ trans('user::general.middle_name') }}</label>
                                    <input type="text" name="middle_name" v-model="middle_name" id="middle_name"
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="city_id" id="city_id" v-model="city_id"
                                        required>
                                ...
                                <div class="form-group">
                                    ...
                                    <v-select label="name" :options="roles" :reduce="role => role.id"
                                        ...
                                        <template #search="{attributes, events}">
                                            <input class="vs__search @error('roles') is-invalid @enderror"
                                                :required="!selected_roles" v-bind="attributes" v-on="events" />
                                        </template>
                                    </v-select>
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="username"
                                        class="control-label">{{ trans_choice('user::general.username', 1) }}</label>
                    ...
                    <div class="row gy-4">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="coop_id" id="coop_id">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="address" id="address" v-model="address"
                                        class="form-control @error('address') is-invalid @enderror" rows="3"></textarea>
                                    @error('address')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
    ...
    <script>
        var app = new Vue({
            ...
            data: {
                ...
                city_id: "{{ old('city_id', $user->city_id) }}",
                branch_id: "{{ old('branch_id', $user->branch_id) }}",
                coop_id: "{{ old('coop_id', $user->coop_id) }}",
                ...
                username: "{{ old('email', $user->username) }}",
