...
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h6 class="box-title">{{ trans_choice('core::general.edit', 1) }}
                {{ trans_choice('core::general.profile', 1) }}</h6>
        ...
        <form method="post" action="{{ url('user/update_profile') }}" class="form" enctype="multipart/form-data">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="middle_name" class="control-label">{{ trans('user::general.middle_name') }}</label>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="gender" id="gender" required>
                        ...
                        <option value="male" @if ($user->gender == 'male') selected @endif>
                            {{ trans_choice('user::general.male', 1) }}</option>
                        <option value="female" @if ($user->gender == 'female') selected @endif>
                            {{ trans_choice('user::general.female', 1) }}</option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                     <label class="control-label" for="city_id">{{ trans_choice('user::general.city', 1) }}</label>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" name="address" id="address" class="form-control" rows="3">{{ $user->address }}</textarea>
                </div>
