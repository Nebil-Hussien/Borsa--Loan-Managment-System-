            ...
            <div class="card-header">
                @can('user.users.create')
                    <a href="{{ url('user/create') }}" class="btn btn-info btn-sm">
                        ...
                        {{ trans_choice('user::general.user', 1) }}
                    </a>
                @endcan
                <div class="btn-group">
                    <div class="dropdown">
                ...
                <table id="data-table" class="table table-striped table-condensed table-hover">
                    <thead>
                        <tr>
                            ...
                            <th><span>{{ trans_choice('core::general.avatar', 1) }}</span></th>
                            <th>
                            ...
                            <th><span>{{ trans_choice('user::general.role', 2) }}</span></th>
                            <th><span>{{ trans_choice('user::general.generate', 2) }}</span></th>
                            <th>
                                <a href="{{ table_order_link('first_name') }}">
                                    ...
                                    <a href="{{ url('user/' . $key->id . '/show') }}">
                                        ...
                                        @else
                                            <img class="img-circle img-size-32 mr-2"
                                                src="{{ asset('themes/adminlte/img/user.png') }}" alt="User Image">
                                        @endif
                                    </a>
                                </td>
                                <td>
                                    <a href="{{ url('user/' . $key->id . '/show') }}">
                                        <span class="tb-lead">{{ $key->first_name }} {{ $key->middle_name }}
                                            {{ $key->last_name }}</span>
                                    </a>
                                </td>
                                <td>
                                ...
                                <td>
                                    @if (!empty(Auth::user()->roles))
                                        <span class="badge badge-primary">
                                            {{ ucfirst($key->roles->first()->name) }}
                                        </span>
                                    @endif
                                </td>
                                <td>
                                    <a href="{{ url('user/' . $key->id . '/qrGenerate') }}"> <button
                                            class="btn btn-primary">
                                            <i class="fa fa-qrcode"></i></button></a>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a href="{{ url('user/' . $key->id . '/show') }}" class="dropdown-item">
                                                <i class="far fa-eye"></i>
                                                <span>{{ trans_choice('core::general.detail', 2) }}</span>
                                            </a>
                                            @can('user.users.edit')
                                                <a href="{{ url('user/' . $key->id . '/edit') }}" class="dropdown-item">
