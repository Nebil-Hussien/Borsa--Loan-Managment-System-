            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ $coop->name }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h6 class="box-title">{{ $coop->name }}</h6>
                    ...
                    <div class="card-body">
                        <table class="table">
                            ...
                            @foreach($custom_fields as $custom_field)
                                <?php
                                $field = custom_field_build_form_field($custom_field, $coop->id);
                                ?>
                                <tr>
                                    <td>{{$field['label']}}</td>
                                    <td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        @can('coop.coops.assign_user')
                                                            ...
                                                            <a href="{{ url('coop/'.$key->id.'/remove_user') }}"
        ...
        <div class="modal fade" id="addUser">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="post" action="{{url('coop/'.$coop->id.'/add_user')}}" class="">
                        {{csrf_field()}}
