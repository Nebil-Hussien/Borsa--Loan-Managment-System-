...
@section('title') {{ trans_choice('core::general.coop',2) }}
@endsection
@section('styles')
@stop
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('core::general.coop',2) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('core::general.coop',2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                @can('coop.coops.create')
                    <a href="{{ url('coop/create') }}"
                       class="btn btn-info btn-sm">
                        <i class="fas fa-plus"></i> {{ trans_choice('core::general.add',1) }} {{ trans_choice('core::general.coop',1) }}
                    </a>
                @endcan
                <div class="btn-group">
                    <div class="dropdown">
                ...
                <div class="card-tools">
                    <form class="form-inline ml-0 ml-md-3" action="{{url('coop')}}">
                    ...
                    <tr>
                        ...
                        <th>
                            <a href="{{table_order_link('open_date')}}">
                                {{ trans_choice('coop::general.open',2) }} {{ trans_choice('core::general.date',1) }}
                            </a>
                        </th>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        @can('coop.coops.destroy')
                                            <a href="{{url('coops/' . $key->id . '/destroy')}}"
