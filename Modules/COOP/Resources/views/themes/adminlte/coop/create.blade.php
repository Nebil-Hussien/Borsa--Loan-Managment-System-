...
@section('title')
    {{ trans_choice('core::general.add', 1) }} {{ trans_choice('core::general.coop', 1) }}
@endsection
@section('content')
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('core::general.add', 1) }}
                            {{ trans_choice('core::general.coop', 1) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content" id="app">
        <form method="post" action="{{ url('coop/store') }}">
            {{ csrf_field() }}
            <div class="card card-bordered card-preview">
                <div class="card-body">
                    <div class="row gy-4">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="open_date" class="control-label">{{ trans_choice('core::general.open', 1) }}
                                    {{ trans_choice('core::general.date', 1) }}</label>
                                <flat-pickr v-model="open_date"
                                    class="form-control  @error('open_date') is-invalid @enderror" name="open_date"
                                    required>
                                </flat-pickr>
                                @error('open_date')
                                    <span class="invalid-feedback" role="alert">
