...
@section('title')
    {{ trans_choice('core::general.edit',1) }} {{ trans_choice('core::general.coop',1) }}
@endsection
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                    href="{{url('coop')}}">{{ trans_choice('core::general.coop',2) }}</a>
                        </li>
                        <li class="breadcrumb-item active">{{ trans_choice('core::general.edit',1) }} {{ trans_choice('core::general.coop',1) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content" id="app">
        <form method="post" action="{{ url('coop/'.$coop->id.'/update') }}">
            {{csrf_field()}}
...
@section('scripts')
    <script>
        var app = new Vue({
            el: "#app",
            data: {
                name: "{{old('name',$coop->name)}}",
                notes: `{{old('notes',$coop->notes)}}`,
                active: "{{old('active',$coop->active)}}",
                open_date: "{{old('open_date',$coop->open_date)}}",
            }
        })
    </script>
@endsection
