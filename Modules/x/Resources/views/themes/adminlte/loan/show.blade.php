                            ...
                            <div class="col-sm-8 col-md-8 p-10">
                                ...
                                @if ($loan->status == 'active' || $loan->status == 'closed' || $loan->status == 'written_off' || $loan->status == 'overpaid' || $loan->status == 'rescheduled')
                                    ...
                                    <h4 class="">
                                        ...
                                        :
                                        <b
                                            class=" @if ($arrears_amount) text-danger @endif">{{ number_format($arrears_amount, $loan->decimals) }}</b>
                                    </h4>
                                    <h4 class="">
                                    ...
                                    <h4 class="">
                                        ...
                                        :
                                        <b class="">{{ number_format($current_principal, $loan->decimals) }}
                                        </b>
                                    ...
                                    <table class="pretty displayschedule" id="summarytable">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th>{{ number_format($principal + $interest + $penalties + $fees, $loan->decimals) }}
                                                </th>
                                                <th>{{ number_format($principal_paid + $interest_paid + $fees_paid + $penalties_paid, $loan->decimals) }}
                                                </th>
                                                <th>{{ number_format($principal_waived + $interest_waived + $fees_waived + $penalties_waived, $loan->decimals) }}
                                                </th>
                                                <th>{{ number_format($principal_written_off + $interest_written_off + $fees_written_off + $penalties_written_off, $loan->decimals) }}
                                                </th>
                                                <th>{{ number_format($principal_outstanding + $interest_outstanding + $fees_outstanding + $penalties_outstanding, $loan->decimals) }}
                                                </th>
                                                <th>{{ number_format($principal_overdue + $interest_overdue + $fees_overdue + $penalties_overdue, $loan->decimals) }}
                                                </th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="lefthighlightcolheader">
                                                    {{ number_format($loan->principal, $loan->decimals) }}</td>
                                                <td></td>
                                                <td class="righthighlightcolheader">
                                                    {{ number_format($loan->principal, $loan->decimals) }}</td>
                                                <td class="lefthighlightcolheader"></td>
                                                <td>{{ number_format($loan->disbursement_charges, $loan->decimals) }}
                                                </td>
                                            ...
                                            @foreach ($loan->repayment_schedules as $key)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ number_format($principal, $loan->decimals) }}</td>
                                                    <td class="righthighlightcolheader">
                                                        {{ number_format($balance, $loan->decimals) }}</td>
                                                    <td class="lefthighlightcolheader">
                                                        {{ number_format($interest, $loan->decimals) }}
                                                    </td>
                                                    <td>{{ number_format($fees, $loan->decimals) }}</td>
                                                    <td class="righthighlightcolheader">
                                                        {{ number_format($penalties, $loan->decimals) }}</td>
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td> {{ $financial->current_asset_amount }}</td>
                                                <td> {{ $financial->current_liability_amount }}</td>
                                                <td> {{ $financial->long_term_liabilit_amount }}</td>
                                                <td> {{ $financial->annual_income_bussiness }}</td>
                                                <td> {{ $financial->monthly_income_bussiness }}</td>
                                                <td> {{ $financial->daily_income_bussiness }}</td>
                                                <td> {{ $financial->annual_expense }} </td>
                                                <td> {{ $financial->monthly_expense }}</td>
                                                <td> {{ $financial->daily_expesnse }} </td>
