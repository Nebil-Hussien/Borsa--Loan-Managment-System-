...
@section('title')
    {{ trans_choice('core::general.Assign_NGO', 2) }}
@endsection
@section('styles')
@stop
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ trans_choice('core::general.Assign_NGO', 2) }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ trans_choice('core::general.Assign_NGO', 2) }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                @can('core.currencies.create')
                    <a href="{{ url('userNGOAssign/create') }}" class="btn btn-info btn-sm">
                        <i class="fas fa-plus"></i> {{ trans_choice('core::general.Assign_NGO', 1) }}</a>
                @endcan
                <div class="btn-group">
                    <div class="dropdown">
                ...
                <div class="card-tools">
                    <form class="form-inline ml-0 ml-md-3" action="{{ url('currency') }}">
                ...
                <table id="data-table" class="table table-striped table-condensed table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <span>{{ trans_choice('core::general.symbol', 1) }}</span>
                            </th>
                            <th>
                                <span>{{ trans_choice('core::general.code', 1) }}</span>
                            </th>
                            <th>
                                <span>{{ trans_choice('core::general.rate', 1) }}</span>
                            </th>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            @can('core.currencies.edit')
                                                <a href="{{ url('currency/' . $key->id . '/edit') }}" class="dropdown-item">
                                                    <i class="far fa-edit"></i>
                                                    <span>{{ trans_choice('core::general.edit', 1) }}</span>
                                                </a>
                                            @endcan
                                            <div class="dropdown-divider"></div>
                                            @can('core.currencies.destroy')
                                                <a href="{{ url('currency/' . $key->id . '/destroy') }}"
