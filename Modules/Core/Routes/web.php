...
//assign User to NGO
Route::prefix('userNGOAssign')->group(function () {
    Route::get('/', 'NgoAssignController@index');
    Route::get('get_userNGO_assign', 'NgoAssignController@get_userNGO_assign');
    Route::get('create', 'NgoAssignController@create');
    Route::post('store', 'NgoAssignController@store');
    Route::get('{id}/show', 'NgoAssignController@show');
    Route::get('{id}/edit', 'NgoAssignController@edit');
    Route::post('{id}/update', 'NgoAssignController@update');
    Route::get('{id}/destroy', 'NgoAssignController@destroy');
});