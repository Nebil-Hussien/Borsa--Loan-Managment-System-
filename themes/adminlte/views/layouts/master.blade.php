...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        ...
        @elseif(Auth::user()->hasRole('NGO_HeadOffice'))
            @include('core::menu.NGO')
        @elseif(Auth::user()->hasRole('NGO_OperationOfficer'))
            @include('core::menu.NGO')
        @elseif(Auth::user()->hasRole('NGO_RegionalManagment'))
            @include('core::menu.NGO')
        @elseif(Auth::user()->hasRole('COOP_HeadOffice'))
            @include('core::menu.coop')
        @elseif(Auth::user()->hasRole('COOP_OperationOffice'))
            @include('core::menu.coop')
        @elseif(Auth::user()->hasRole('COOP_RegionalManagment'))
            @include('core::menu.coop')
        @elseif(Auth::user()->hasRole('Partners'))
            @include('core::menu.partners')
        @else
